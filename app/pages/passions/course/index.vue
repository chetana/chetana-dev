<template>
  <div class="section course-page">
    ...
    <p class="page-subtitle">Toutes mes sorties Strava — stats, allure et progression.</p>

    <!-- ── Stats accordéon ── -->
    <div v-if="stats" class="profile-section">
      <button class="stats-toggle" @click="statsOpen = !statsOpen">
        <span class="stats-toggle-label">📊 Mes stats course</span>
      ...
      <div class="stats-body" :class="{ open: statsOpen }">
        ...
        <div class="stats-strip">
          ...
          <div class="stat-item">
            ...
            <span class="stat-label">couru</span>
          </div>
          <div class="stat-item">
              ...
              <div v-for="(r, i) in stats.top_rides" :key="r.id" class="top-ride">
                ...
                <div class="ride-info">
                  ...
                  <span class="ride-meta">
                    ...
                    <span v-if="r.average_speed_ms"> · {{ formatPaceRun(r.average_speed_ms) }}/km</span>
                  </span>
      ...
      <div v-else-if="activities?.length" class="rides-list">
        <div v-for="a in displayed" :key="a.id" class="ride-card">
          ...
          <div class="ride-card-stats">
            ...
            <span v-if="a.average_speed_ms" class="ride-stat">💨 {{ formatPaceRun(a.average_speed_ms) }}/km</span>
...
const { data: stats, pending: statsPending } = useFetch<RunStats>(`${API_BASE}/strava/stats?sport=running`)
const { data: activities, pending: activitiesPending } = useFetch<Activity[]>(`${API_BASE}/strava/activities?sport=running`)
...
function formatPaceRun(speedMs: number) {
...
.km-fill   { background: linear-gradient(180deg, #f97316, #ea580c); }
...
.ride-card:hover { border-color: #f97316; }
...
.ride-tag.type { background: rgba(249,115,22,0.1); color: #fb923c; border: 1px solid rgba(249,115,22,0.2); }
